...
def test_the_same_posture_without_the_exercise_label_still_misfires(scoring):
    ...
    """
    record = compute_triage("t", hold(scoring, scoring.history_len, exercise=""), 2.0, scoring)
...
def test_an_exercise_with_no_profile_scores_on_the_default_weights(scoring):
    ...
    unlabelled = compute_triage("t", hold(scoring, scoring.history_len, exercise=""), 2.0, scoring)
